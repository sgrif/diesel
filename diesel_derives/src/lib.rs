...
/// annotate your struct with `#[diesel(changeset_options(treat_none_as_null =
/// true))]`.
///
/// # Attributes
///
...
///
/// * `#[diesel(changeset_options(treat_none_as_null = true))]`, specifies that
...
///
/// For PostgreSQL, add `#[diesel(postgres_type(type_name = "pg_type_name", type_schema = "pg_schema_name"))]`
/// or `#[diesel(postgres_type(oid = "some_oid", array_oid = "some_oid"))]` for
/// builtin types.
/// For MySQL, specify which variant of `MysqlType` should be used
/// by adding `#[diesel(mysql_type("Variant"))]`.
/// For SQLite, specify which variant of `SqliteType` should be used
/// by adding `#[diesel(sqlite_type("Variant"))]`.
///
/// # Attributes
///
/// ## Type attributes
///
/// * `#[diesel(postgres_type(type_name = "TypeName", type_schema = "public"))]` specifies support for
...
/// * `#[diesel(sqlite_type("TypeName"))]`, specifies support for a sqlite type
/// with the given name. `TypeName` needs to be one of the possible values
/// in `SqliteType`
/// * `#[diesel(mysql_type("TypeName"))]`, specifies support for a mysql type
/// with the given name. `TypeName` needs to be one of the possible values
/// in `MysqlType`
#[proc_macro_error]
